...
public class AgentTest {
    ...
    public void testWorkerCompletions() throws Exception {
        ...
        new ExpectedTasks().
            addTask(new ExpectedTaskBuilder("foo").
                workerState(new WorkerRunning("foo", fooSpec, 0, new TextNode("sample task started"))).
                build()).
            waitFor(client);
        ...
        new ExpectedTasks().
            addTask(new ExpectedTaskBuilder("foo").
                workerState(new WorkerDone("foo", fooSpec, 0, 1,
                    new TextNode("sample task halted"), "")).
                build()).
            addTask(new ExpectedTaskBuilder("bar").
                workerState(new WorkerRunning("bar", barSpec, 0,
                    new TextNode("sample task started"))).
                build()).
            waitFor(client);
        ...
        new ExpectedTasks().
            ...
            addTask(new ExpectedTaskBuilder("bar").
                workerState(new WorkerDone("bar", barSpec, 0, 2,
                    new TextNode("sample task halted"), "baz")).
                build()).
            waitFor(client);
    }
