...
public class TestFixture {
    ...
    public static MiniSoakCluster createRoleTestCluster() throws Exception {
        ...
        builder.addNodeWithInstanceId("broker0", new SoakNodeSpec.Builder().
            roles(roles0).build());
        builder.addNodeWithInstanceId("broker1", new SoakNodeSpec.Builder().
            roles(roles0).build());
        builder.addNodeWithInstanceId("broker2", new SoakNodeSpec.Builder().
            roles(roles0).build());
        ...
        builder.addNodeWithInstanceId("zk0", new SoakNodeSpec.Builder().
            roles(roles1).build());
        builder.addNodeWithInstanceId("zk1", new SoakNodeSpec.Builder().
            roles(roles1).build());
        builder.addNodeWithInstanceId("zk2", new SoakNodeSpec.Builder().
            roles(roles1).build());

        List<Role> roles2 = Arrays.asList(new Role[] {
            new TrogdorCoordinatorRole()
        });
        builder.addNodeWithInstanceId("trogdor0", new SoakNodeSpec.Builder().
            roles(roles2).build());
