...
public final class BrokerStartAction extends Action {
    ...
    public BrokerStartAction(String scope) {
        super(new ActionId(TYPE, scope),
            new ActionId[]{
                new ActionId(ZooKeeperStartAction.TYPE, ActionId.SCOPE_ALL)
            },
            new ActionId[] {});
    }
    ...
    public static String[] createSetupPathsCommandLine() {
        return new String[] {"-n", "--",
            "rm", "-rf", ActionPaths.KAFKA_OPLOGS, KAFKA_LOGS, "&&",
            "sudo", "mkdir", "-p", ActionPaths.KAFKA_ROOT, "&&",
            "sudo", "chown", "`whoami`", ActionPaths.KAFKA_ROOT, "&&",
            "mkdir", "-p", ActionPaths.KAFKA_SRC, ActionPaths.KAFKA_CONF,
            ActionPaths.KAFKA_OPLOGS, KAFKA_LOGS};
    }
    ...
    public static String[] createRunDaemonCommandLine() {
        return new String[] {"-n", "--", "nohup", "env",
            ...
            ActionPaths.KAFKA_START_SCRIPT, ActionPaths.KAFKA_BROKER_PROPERTIES, "&>", "/dev/null", "&"};
    }
