...
public final class DaemonStartAction extends Action {
    ...
    public DaemonStartAction(String scope) {
        super(new ActionId(TYPE, scope),
            new ActionId[] {},
            new ActionId[] {
                new ActionId(BrokerStartAction.TYPE, scope),
                new ActionId(ZooKeeperStartAction.TYPE, scope),
                new ActionId(TrogdorDaemonType.COORDINATOR.startType(), scope),
                new ActionId(TrogdorDaemonType.AGENT.startType(), scope)
            });
    }
}
