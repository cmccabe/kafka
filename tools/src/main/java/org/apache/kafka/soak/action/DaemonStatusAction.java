...
public final class DaemonStatusAction extends Action {
    ...
    public DaemonStatusAction(String scope) {
        super(new ActionId(TYPE, scope),
            new ActionId[] {},
            new ActionId[] {
                new ActionId(BrokerStatusAction.TYPE, scope),
                new ActionId(ZooKeeperStatusAction.TYPE, scope),
                new ActionId(TrogdorDaemonType.COORDINATOR.statusType(), scope),
                new ActionId(TrogdorDaemonType.AGENT.statusType(), scope)
            });
    }
}
