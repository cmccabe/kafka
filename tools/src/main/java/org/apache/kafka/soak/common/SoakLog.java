...
public final class SoakLog implements AutoCloseable, Logger {
    ...
    public static SoakLog fromFile(String logBase, String nodeName) throws IOException {
        File file = new File(new File(logBase), nodeName + ".log");
        FileOutputStream outputStream = new FileOutputStream(file, true);
        SoakLog log = null;
        try {
            log = new SoakLog(nodeName, outputStream);
        } finally {
            if (log == null) {
    ...
    public static SoakLog fromStdout(String name) throws IOException {
        return new SoakLog(name, System.out);
    }

    public SoakLog(String name, OutputStream outputStream) {
        this.name = name;
    ...
    void log(String msg, Object... objs) {
        print(MessageFormatter.arrayFormat(msg, objs).getMessage());
    }
