    ...
    class ScribeThread extends KafkaThread {
            ...
            try {
                ...
                while (true) {
                    ...
                    if (shouldRenounceEpoch > -1L) {
                        listener.renounce(shouldRenounceEpoch);
                    }
                    if (shouldClaimEpoch > -1L) {
                        listener.claim(shouldClaimEpoch);
                    }
                    switch (curState) {
                        case FOLLOWER:
                        case BECOMING_LEADER:
                        ...
                        case LEADER:
                            ...
                            if (toWrite != null) {
                                for (ApiMessageAndVersion message : toWrite) {
                                    ...
                                    listener.commit(leaderInfo.epoch, index,
                                        message.message());
                                    index++;
                                }
                            }
        ...
        private int readNextMessage() throws IOException {
            ...
            if (frameInt < 0) {
                ...
                listener.commit(leaderInfo.epoch, index, message);
                index++;
            }
