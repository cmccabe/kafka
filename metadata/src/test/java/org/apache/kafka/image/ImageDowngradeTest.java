...
public class ImageDowngradeTest {
    ...
    static List<ApiMessageAndVersion> premodernMetadataVersionRecords(MetadataVersion metadataVersion) {
        return Arrays.asList(new ApiMessageAndVersion(
                        new ConfigRecord().
                                setResourceType(ResourceType.TOPIC.code()).
                                setResourceName("__cluster_metadata").
                                setName(MetadataVersion.FEATURE_NAME).
                                setValue(metadataVersion.toString()), (short) 0),
    ...
    public void testPremodernVersion() {
        writeWithExpectedLosses(MetadataVersion.IBP_3_2_IV0,
            ...
            Arrays.asList(
                premodernMetadataVersionRecords(MetadataVersion.IBP_3_2_IV0).get(0),
                premodernMetadataVersionRecords(MetadataVersion.IBP_3_2_IV0).get(1),
                TEST_RECORDS.get(0),
                TEST_RECORDS.get(1)));
    }
    ...
    private static void writeWithExpectedLosses(
        ...
        MetadataImage image = delta.apply(ImageProvenance.EMPTY);
        ...
        assertEquals(expectedOutputs, records, "Failed to get expected output records.");
    }
}
